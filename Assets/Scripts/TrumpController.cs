...
public class TrumpController : MonoBehaviour {
	...
	void InitiateTwitter()
	{
		...
		rb_tweet.GetComponent<Renderer> ().material = renderer.material;
	...
	void RandomizeTweet()
	{
		int randomChannel = Random.Range (0, ChannelColors.Length);
		renderer.material = ChannelColors [randomChannel];
